              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    AYA Community Centre<br />
                    Ampain, Ellemebelle Constituency<br />
                    Western Region, Ghana<br />
                    (Next to the refugee camp)
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Day Care Centre for the Elderly<br />
                    All services provided FREE of charge<br />
                    Open to elderly in the Ellemebelle constituency
                  </p>
                </div>
              </div>
            </div>
